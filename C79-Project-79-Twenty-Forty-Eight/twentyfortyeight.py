...
def makeMove(board, move):
    ...
    for columnSpaces in allColumnsSpaces:  # Loop over all 4 columns.
        ...
        column = [fistTile, secondTile, thirdTile, fourthTile]
        combineTilesColumn = combineTilesInColumn(column)

        # Set up the new board data structure with the combined tiles:
        boardAfterMove[firstTileSpace] = combineTilesColumn[0]
        boardAfterMove[secondTileSpace] = combineTilesColumn[1]
        boardAfterMove[thirdTileSpace] = combineTilesColumn[2]
        boardAfterMove[fourthTileSpace] = combineTilesColumn[3]
