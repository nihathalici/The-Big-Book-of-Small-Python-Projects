...
========================================================
This program has several functions for generating different kinds of click- bait headlines.
...
![Sample output Clickbait Headline Generator](https://github.com/nihathalici/The-Big-Book-of-Small-Python-Projects/blob/main/C11-Project-11-Clickbait-Headline-Generator/clickbait_sample_output.PNG)
